...
/*
 * GETMatchingDBValueFunction
 * MatchingDB의 값을 가져올 떄 사용
 * 메서드 : /matchingdb -GET-
 */

public class GETMatchingDBValueHandler implements RequestHandler<Object, String> {
    ...
    public String handleRequest(Object input, Context context) {
    	...
    	QuerySpec querySpec = new QuerySpec()
    			...
    			.withValueMap(new ValueMap().withString(":v_id", "PartitionKEY"));
    ...
    private String getResponse(ItemCollection<QueryOutcome> items) {
        ...
        String response = "{ \"MatchingDB_data\": [";
