...
public class WorkerSensorDBRecordingHandler implements RequestHandler<Document, String> {
    ...
    private String persistData(Document document) throws ConditionalCheckFailedException {
        ...
        return this.dynamoDb.getTable(DYNAMODB_TABLE_NAME)
                .putItem(new PutItemSpec().withItem(new Item().withPrimaryKey("WorkerId", workerId)
                		.withLong("workTime", document.timestamp)
