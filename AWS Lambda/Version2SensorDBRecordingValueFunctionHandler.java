...
public class Version2SensorDBRecordingValueFunctionHandler implements RequestHandler<Document, String> {
    ...
    private String persistData(Document document) throws ConditionalCheckFailedException {
        ...
        return this.dynamoDb.getTable(DYNAMODB_TABLE_NAME)
                .putItem(new PutItemSpec().withItem(new Item().withPrimaryKey("partitionKEY", "PartitionKEY")
                		.withLong("sensorTime", document.timestamp)
