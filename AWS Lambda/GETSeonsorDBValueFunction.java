...
/*
 * GETSeonsorDBValueFunction
 * SensorDB의 값을 가져올 떄 사용
 * 메서드 : /sensordb -GET-
 */

public class GETSensorDBValueFunctionHandler implements RequestHandler<Event, String> {

	private DynamoDB dynamoDb;
    private String DYNAMODB_TABLE_NAME = "SensorDB";
    ...
    public String handleRequest(Event input, Context context) {
        ...
        QuerySpec querySpec = new QuerySpec()
                ...
                .withNameMap(new NameMap().with("#t", "sensorTime"))
